...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="static/js/muselect/docs/css/bootstrap-3.3.2.min.css" type="text/css">
        <link rel="stylesheet" href="static/js/muselect/docs/css/bootstrap-example.css" type="text/css">
        <link rel="stylesheet" href="static/js/muselect/docs/css/prettify.css" type="text/css">

        <script type="text/javascript" src="static/js/muselect/docs/js/jquery-2.1.3.min.js"></script>
        <script type="text/javascript" src="static/js/muselect/docs/js/bootstrap-3.3.2.min.js"></script>
        <script type="text/javascript" src="static/muselect/docs/js/prettify.js"></script>

        <link rel="stylesheet" href="static/js/muselect/dist/css/bootstrap-multiselect.css" type="text/css">
        <script type="text/javascript" src="static/js/muselect/dist/js/bootstrap-multiselect.js"></script>
...
<body >
	...
	<c:forEach items="${oldfactoryList}" var="factory">
			...
			<input type="checkbox" value='1' name ="old_ids" checked="checked"  disabled="disabled" /><label>${factory.factoryname } </label><br>
			</c:if>
	</c:forEach>
	<hr>
