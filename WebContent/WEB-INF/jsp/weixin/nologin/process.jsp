...
<script type="text/javascript">
	...
	function toprocess_details(id){
		window.location.href="<%=basePath %>/wxuser/process_details?fromUserName=${pd.fromUserName }&toUserName=${pd.toUserName }&apppackid="+id;
	}
...
<body>
  ...
  <h1 class="am-header-title">工厂新闻</h1>  
...
<script type="text/javascript">
 ...
 <!--3-->
    ...
    <div class="am-list-news-hd am-cf">   
        <a href="javascript:void(0);" onclick="toprocess()"  class="">
          <h2>新闻动态</h2>
  ...
  <ul class="am-list">       
      ...
      <c:forEach items="${list_app_packs}" var="apppack" > 
 
		 <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left">
		        <div class="am-u-sm-4 am-list-thumb">
		          <a href="javascript:void(0);" class="">
		            <img src="<%=basePath %>uploadFiles/uploadImgs/${apppack.path } " alt=""/>
		          </a>
		        </div>
		        <div class=" am-u-sm-8 am-list-main">
		            <h3 class="am-list-item-hd">
		            	<a href="javascript:void(0);" onclick="toprocess_details('${apppack.id }')"  class="">
		            		${apppack.miaosu }</a></h3>
