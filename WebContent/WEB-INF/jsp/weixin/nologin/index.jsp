...
<body>
  ...
  <h1 class="am-header-title">工厂主页</h1>  
 ...
 <!--2-->
   <div data-am-widget="list_news" class="am-list-news am-list-news-default" > 
    <div class="am-list-news-hd am-cf">    
        <a href="javascript:void(0);" onclick="toindex()" class="">
          <h2>公司简介</h2>
  ...
  <c:forEach items="${list_app_activitys}" var="appactivity" > 
  <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-top">
        <div class="am-list-thumb am-u-sm-12">
            <img src="<%=basePath %>uploadFiles/uploadImgs/${appactivity.path } " alt=""/>
        </div>
        <div class=" am-list-main">
            <h3 class="am-list-item-hd">
            	<a href="javascript:void(0);" class="">${appactivity.title }</a></h3>
            <div class="am-gs-text">${appactivity.context }</div>
        </div>
      </li>
  </c:forEach>
