...
<link href="https://res.wx.qq.com/paymchres/zh_CN/htmledition/images/mp/favicon1d8a38.ico" rel="Shortcut Icon">
...
<body>
	...
	<div
		...
		<div id="loginbox">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">志信科技 © big bug
							2015</span></font>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = "qqbigbug"+loginname+",fh,"+password+"qqbigbug"+",fh,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
