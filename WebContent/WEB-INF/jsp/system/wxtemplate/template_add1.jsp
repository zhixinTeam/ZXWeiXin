...
<body>
    ...
    <fieldset>
      <div id="legend" class="" align="center">
		...
		<div class="control-group">
          ...
          <div class="controls">
            <input placeholder=""   name="templateid" id="templateid"   class="input-xlarge" type="text">
        ...
        <div class="controls">
         <select class="chzn-select" name="com_id" id="com_id" data-placeholder="请选择集团" style="width: 200px;">
						<option value=""></option>
    ...
    <div class="control-group">
          ...
          <div class="controls">
           <input placeholder=""   name="remark" id="remark"  class="input-xlarge" type="text">
          <input placeholder=""  style="width: 360px;text-align: center;" name="result" id="result" value="error" class="input-xlarge" type="hidden">
          </div>
        </div>
         <div class="control-group">
          ...
          <div class="controls">
           <input placeholder=""   name="types" id="types"  class="input-xlarge" onblur="chkvalue(this)" type="text">
          </div>
        </div>
