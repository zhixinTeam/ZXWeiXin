...
<body>
	<form class="form-horizontal" action="appactivity/${msg}" name="comForm" id="comForm" method="post" enctype="multipart/form-data">
    ...
    <fieldset>
      <div id="legend" class="">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input placeholder=""   name="title" id="title" value="${pd.title }"  class="input-xlarge" type="text">
