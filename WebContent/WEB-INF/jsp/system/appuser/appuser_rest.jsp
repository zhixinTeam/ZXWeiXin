...
<body>
	<form action="wxuser/saveU" name="userForm" id="userForm" method="post">
		...
		<table>
			...
			<tr>
				<td><input type="text" name="susernumber" id="susernumber" value="${pd.susernumber }" maxlength="32" placeholder="这里输入客户号" title="编号" onblur="hasN('${pd.USERNAME }')"/></td>
			</tr>
